#pragma once
// Public-domain 8x8 bitmap font (font8x8_basic by Daniel Hepper, in the public
// domain). Each glyph is 8 bytes (one row each, LSB = leftmost pixel). Indices
// 0x20..0x7E are the printable ASCII set the UI draws; others may be blank.
#include <cstdint>
namespace liminal {
inline constexpr unsigned char kFont8x8Basic[128][8] = {
